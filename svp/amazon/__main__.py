...
@click.option('--memory-ratio', type=float, default=1,
              help=('Ratio of memory samples to sample size'))
@click.option('--samples-ratio', type=float, default=1,
              help=('Ratio of samples used to sample size'))
@computing_options
@miscellaneous_options
def active(run_dir: str,
           ...
           seed: int, checkpoint: str, track_test_acc: bool,
           memory_ratio: float, samples_ratio: float):
...
@click.option('--quantize', default=False,
              help='Quantize Fasttext model.')
...
def fasttext(executable: str,
             ...
             sizes: Tuple[int, ...], selection_method: str, quantize: bool,
